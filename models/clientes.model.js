...
const create = ({ nombre, apellidos, direccion, telefono, fecha_nacimiento, email, dni}) => { 
  ...
  return executeQuery('insert into clientes (nombre, apellidos, direccion, telefono, fecha_nacimiento, email, dni) values (?,?,?,?,?,?,?)',
...
const update = (pClienteId, { nombre, apellidos, direccion, telefono, fecha_nacimiento, email, dni }) =>{
  ...
  return executeQuery('update clientes set nombre=?, apellidos=?, direccion=?, telefono=?, fecha_nacimiento=?, email=?, dni=? where id=?', [nombre, apellidos, direccion, telefono, fecha_nacimiento, email, dni, pClienteId])
}
